...
const CourseDetail = () => {
    ...
    if(isError) return <h1 className='text-center mt-20'>Failed to load course details</h1>
                        ...
                        <CardContent className="p-4 flex flex-col">
                            <div className='w-full aspect-video mb-4'>
                                <ReactPlayer 
                                    width="100%"
                                    height="100%"
                                    url={course.lectures[0]?.videoUrl || "https://www.youtube.com/watch?v=dQw4w9WgXcQ"}
                                    controls = {true}
                                />
                            </div>
                            <h1>Lecture Title</h1>
